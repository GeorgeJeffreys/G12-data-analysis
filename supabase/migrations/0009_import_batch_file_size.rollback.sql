-- ============================================================================
-- Rollback for 0009_import_batch_file_size.sql
--
-- Restores `ingest_persist` to its 0007 form (no file_size_mb in the
-- import_batches insert) and drops the `file_size_mb` column. Run in the
-- Supabase SQL editor only if you need to undo migration 0009. No 0001–0008
-- data is affected.
-- ============================================================================

begin;

-- Restore the 0007 persist function (without file_size_mb).
...
alter table import_batches drop column if exists file_size_mb;
