-- ============================================================================
-- Rollback for 0010_items_item_set.sql
--
-- Restores `ingest_persist` to its 0009 form (no item_set in the items insert)
-- and drops the `items.item_set` column. Run in the Supabase SQL editor only if
-- you need to undo migration 0010. No 0001–0009 data is affected.
-- ============================================================================

begin;

-- Restore the 0009 persist function (without item_set).
...
alter table items drop column if exists item_set;
