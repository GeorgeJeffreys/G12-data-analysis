-- 0037 rollback — restore the pre-0037 role-based guards on every RPC 0037 swapped
-- onto app.has_permission. Each function is recreated verbatim from its prior
-- definition (has_role / is_workspace_admin / can_override). Reverses 0037 only;
-- does not drop app.has_permission (that belongs to 0036).
