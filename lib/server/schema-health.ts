...
export const BRING_CURRENT_MIGRATION = "0024_authorization_workspace_scope.sql";
...
const HEALTHY: SchemaHealth = { ok: true, migration: "0024", missingColumns: [], missingFunctions: [] };
